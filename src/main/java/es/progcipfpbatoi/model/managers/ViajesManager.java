...
public class ViajesManager {
    ...
    private void init() {
        ...
        viajes.add(new Flexible(2, new Usuario("javloplah", "12345"), "Alcoy-Onil", 20, 4, 6, LocalDateTime.parse("16-05-2024T07:30", DateTimeFormatter.ofPattern("dd-MM-yyyy'T'HH:mm"))));
        viajes.add(new Exclusivo(3, new Usuario("Oscar", "12345"), "Alcoy-L'Orxa", 30, 4, 10, LocalDateTime.parse("17-05-2024T08:30", DateTimeFormatter.ofPattern("dd-MM-yyyy'T'HH:mm"))));
        viajes.add(new Flexible(4, new Usuario("Felipe", "12345"), "Alcoy-Ibi", 15, 4, 3, LocalDateTime.parse("18-05-2024T09:30", DateTimeFormatter.ofPattern("dd-MM-yyyy'T'HH:mm"))));
        viajes.add(new Exclusivo(5, new Usuario("Sergio", "12345"), "Alcoy-Castalla", 15, 4, 4, LocalDateTime.parse("19-05-2024T10:30", DateTimeFormatter.ofPattern("dd-MM-yyyy'T'HH:mm"))));
        ...
        viajes.add(new Cancelable(7, new Usuario("Jorge", "12345"), "Alcoy-Ibiza", 220, 4, 50, LocalDateTime.parse("21-05-2024T12:30", DateTimeFormatter.ofPattern("dd-MM-yyyy'T'HH:mm"))));
        viajes.add(new Cancelable(8, new Usuario("Joan", "12345"), "Alcoy-Mallorca", 250, 4, 50, LocalDateTime.parse("22-05-2024T13:30", DateTimeFormatter.ofPattern("dd-MM-yyyy'T'HH:mm"))));
        viajes.add(new Flexible(9, new Usuario("frapujgal", "12345"), "Alcoy-Fuenlabrada", 100, 4, 30, LocalDateTime.parse("23-05-2024T14:30", DateTimeFormatter.ofPattern("dd-MM-yyyy'T'HH:mm"))));
        viajes.add(new Cancelable(10, new Usuario("frapujgal", "12345"), "Alcoy-Teruel", 150, 4, 25, LocalDateTime.parse("24-05-2024T15:30", DateTimeFormatter.ofPattern("dd-MM-yyyy'T'HH:mm"))));
    }
